...
public class Location1v2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View v = inflater.inflate(R.layout.location1, container, false);
        ...
        tpmv = "http://10.10.0.1/index.php?username="
                ...
                + "&password="
                + password
                + "&act=query_lmv&dbc=E2S2&col=tp&sn=408BC7D6";
        urls[1] = tpmv;
        ...
        hmmv = "http://10.10.0.1/index.php?username="
                ...
                + "&password="
                + password
                + "&act=query_lmv&dbc=E2S2&col=hm&sn=408BC7D6";
        urls[2] = hmmv;
        ...
        dumv = "http://10.10.0.1/index.php?username="
                ...
                + "&password="
                + password
                + "&act=query_lmv&dbc=E2S2&col=du&sn=408BC7D6";
        urls[3] = dumv;
